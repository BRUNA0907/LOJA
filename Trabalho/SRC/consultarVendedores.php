    ...
    <body class="w3-content" style="max-width:1200px"> <!-- menu tam -->
       ...
       <div class="w3-main" style="margin-left:250px">
            ...
            <header class="w3-container w3-xlarge">
              <p class="w3-left">Consulta de Vendedores</p>
              <p class="w3-right"></p>
            </header>
                ...
                <tbody>
                    <?php
                        while ($registro = $resultado->fetch(PDO::FETCH_ASSOC)) {
                            echo "<tr>";
                            echo "<td>" . $registro["cpf_cnpj_vend"] . "</td>".
                                 "<td>" . $registro["nome_vend"] . "</td>".

                                 "<td>" . "<a href='editarVendedor.php?cpf_cnpj_vend=" . $registro["cpf_cnpj_vend"] . "'><button>Editar</button></a>" . "</td>".
                                 "<td>" . "<a href='excluirVendedor.php?cpf_cnpj_vend=" . $registro["cpf_cnpj_vend"] . "'><button>Deletar</button></a>" . "</td>";
                            echo "</tr>";
                        }
                    ?>
                </tbody>
