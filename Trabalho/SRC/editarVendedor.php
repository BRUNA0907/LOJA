       ...
       <div class="w3-main" style="margin-left:250px">
         ...
         <div>    
                ...
                <form action="AtualizarVendedor.php" method="post">
                   <fieldset>
                        <legend>Editar Vendedor</legend><br><br> 
                        <label>CPF do Vendedor</label><br>
                        <input type="text" readonly name="form_cpf" value="<?= $registro["cpf_cnpj_vend"] ?>"><br>
                        <label>Nome do Vendedor</label><br>
                        <input type="text" name="form_nome" value="<?= $registro["nome_vend"] ?>"><br>
