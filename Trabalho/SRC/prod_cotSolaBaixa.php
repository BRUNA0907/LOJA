...
<body class="w3-content" style="max-width:1200px"> <!-- menu tam -->
 ...
 <?php
        ...
        $select = $conexao->prepare("SELECT * FROM produto where id_categoria = 5");
        $select->execute();
...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:200px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
     ...
     <a href="prod_verao.php" class="w3-bar-item w3-button">Verão</a>
      <a href="prod_inverno.php" class="w3-bar-item w3-button">Inverno</a>
